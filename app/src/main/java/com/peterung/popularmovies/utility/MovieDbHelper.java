package com.peterung.popularmovies.utility;
...
public class MovieDbHelper {
    ...
    public final int SYNC_INTERVAL = 60 * 180;;
     ...
     */
    public void syncMoviesImmediately() {
     ...
     * Helper method to have the sync adapter sync movies immediately
     */
    public void syncReviewsAndTrailersImmediately(long movieId) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(ContentResolver.SYNC_EXTRAS_EXPEDITED, true);
        bundle.putBoolean(ContentResolver.SYNC_EXTRAS_MANUAL, true);
